...
The first step is to create a *Description* of your new (or existing) *Microfrontend*.
...
it at */public/Microfrontend.js* (because the *basePath* is /public).

## Starter

On the *Host Application* side, you can start the *Microfrontend* like this with a *Starter* generated by [OpenMicrofrontends Generator](https://github.com/Open-Microfrontends/open-microfrontends-generator){target="_blank"}:
...
which can be used like below (here, for example, with [Express](https://expressjs.com/){target="_blank"}).
...
[OpenMicrofrontend Generator Documentation](generator.md){ .md-button }
